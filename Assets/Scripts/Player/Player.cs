...
public class Player : Entity
{
    ...
    [Range(0f, 1f)]
    public float inAirMoveMultiplier = .7f; //should be from 0 to 1 for best outcome
    [Range(0f, 1f)]
    ...
    public void TeleportPlayer(Vector3 targetPosition) => transform.position = targetPosition;
    ...
    private void OnEnable()
    {
        ...
        input.Player.SkillTree.performed += ctx => ui.ToggleSkillTreeUI();
